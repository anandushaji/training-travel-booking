      ...
      return messagePact
        ...
        .withContent({
          ...
          data: {
            ...
            travelerName: like('Alice Smith'),
            travelerEmail: like('alice@example.com'),
            totalAmount: like(450.0),
            currency: like('USD'),
            origin: like('JFK'),
            destination: like('LAX'),
            departureDate: like('2026-06-01'),
          },
        })
        ...
        .verify(
          asynchronousBodyHandler(async (body: unknown) => {
            ...
            expect(event.data.travelerName).toBeDefined();
