...
// @ts-nocheck
/**
 * Integration test: BudgetController with real PostgreSQL (Testcontainers).
...
describeIf('BudgetController (integration)', () => {
  let app: any;
  ...
  it('POST /api/v1/budgets with duplicate department+fiscalYear returns 409', async () => {
